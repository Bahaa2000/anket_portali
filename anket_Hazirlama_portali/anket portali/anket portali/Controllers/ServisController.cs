...
using anket_portali.Models;
using anket_portali.ViewModel;


namespace anket_portali.Controllers
{
    public class ServisController : ApiController
    {
        ...
        public SonucModel UyeSil(int UydId)
        {
            TUye kayit = db.TUye.Where(s => s.UyeId == UydId).SingleOrDefault();
            if (kayit == null)
            {
                sonuc.islem = false;
                sonuc.mesaj = "Kayıt Bulunamadı...";
